...
#获取新闻链接的rss源
rss_urls=['https://rss.nytimes.com/services/xml/rss/nyt/Business.xml',
...
def get_xpaths(url):
    ...
    if(host=="www.nytimes.com"):
        #应从数据库获取，分别对应title、date、author、imagepath、content
        xpaths=["/html/body/div/div/div[1]/div[2]/main/div/article/header/div[3]/h1",
                "/html/body/div/div/div/div[2]/main/div/article/header/div[7]/div/time",
                "/html/body/div/div/div/div[2]/main/div/article/header/div[6]/div/div[2]/p/span[2]/a",
                "/html/body/div/div/div/div[2]/main/div/article/header/div[5]/div[2]/figure/div/picture/img/@src",
                "/html/body/div/div/div/div[2]/main/div/article/section"
                ]
    if(host=="www.newsweek.com"):
        xpaths=["/html/body/div[4]/div/div[3]/div[1]/div[1]/div/article/header/h1",
                "/html/body/div[4]/div/div[3]/div[1]/div[1]/div/article/header/div[2]/time",
                "/html/body/div[4]/div/div[3]/div[1]/div[1]/div/article/header/div[2]/span/a",
                "/html/body/div[4]/div/div[3]/div[1]/div[1]/div/article/div[1]/div[5]/figure[1]/div/picture/img",
                "/html/body/div[4]/div/div[3]/div[1]/div[1]/div/article/div[1]/div[5]"
                ]
    if(host=="www.forbes.com"):
        xpaths=["/html/body/div[1]/article[1]/main/div[2]/div[2]/div[1]/div[1]/div/h1",
                "/html/body/div[1]/article[1]/main/div[2]/div[2]/div[1]/div[2]/div/div[2]/div[2]/time",
                "/html/body/div[1]/article[1]/main/div[2]/div[2]/div[1]/div[2]/div/div[1]/div/div/div[1]/span/a",
                "/html/body/div[1]/article[1]/main/div[2]/div[2]/div[1]/div[3]/div[1]/figure/div/progressive-image/img",
                "/html/body/div[1]/article[1]/main/div[2]/div[2]/div[1]/div[3]/div[1]"
                ]
    return xpaths
...
def get_css_selectors(url):
    ...
    if(host=="www.forbes.com"):
        css_selectors=[".fs-headline",
                ".content-data time",
                ".contrib-link--name",
                ".image-embed__placeholder img[src]",
                ".article-body p"
                ]   
...
def crawl_news_Selenium(site_url,path="xpath"):
    ...
    if(path=="xpath"):
        ...
        #title、content为必须
        try:
            title=wait.until(EC.presence_of_element_located((By.XPATH,xpaths[0]))).text
            content=wait.until(EC.presence_of_element_located((By.XPATH,xpaths[4]))).text
        except:
            return
        publish_date=author=image_path=""
        try:
            image_path=wait.until(EC.presence_of_element_located((By.XPATH,xpaths[3]))).get_attribute('src')
            publish_date=wait.until(EC.presence_of_element_located((By.XPATH,xpaths[1]))).text
            author=wait.until(EC.presence_of_element_located((By.XPATH,xpaths[2]))).text
        except:
            pass
    if(path=="css_selector"):
        css_selectors=get_css_selectors(site_url)
        #title、content为必须
        try:
            title=wait.until(EC.presence_of_element_located((By.CSS_SELECTOR,css_selectors[0]))).text
            content=wait.until(EC.presence_of_element_located((By.CSS_SELECTOR,css_selectors[4]))).text
        except:
            return
        publish_date=author=image_path=""
        try:
            image_path=wait.until(EC.presence_of_element_located((By.CSS_SELECTOR,css_selectors[3]))).get_attribute('src')
            publish_date=wait.until(EC.presence_of_element_located((By.CSS_SELECTOR,css_selectors[1]))).text
            author=wait.until(EC.presence_of_element_located((By.CSS_SELECTOR,css_selectors[2]))).text
        except:
            pass    
    df = pd.DataFrame(
        {
